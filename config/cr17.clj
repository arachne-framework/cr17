...
(alias 'app 'org.arachne-framework.cr17)
...
(a/component ::app/robohash
  'org.arachne-framework.cr17.visual-hash/new-robohash)
...
(p/server ::app/server 8080
  ...
  (h/endpoint :get "/healthcheck"
    (h/handler 'org.arachne-framework.cr17.web/healthcheck))

  (h/endpoint :get "/robot/:name"
    (h/handler 'org.arachne-framework.cr17.web/robot {:vhash ::app/robohash}))

  )

;; ClojureScript setup
(def cljs-opts {:main 'org.arachne-framework.cr17
