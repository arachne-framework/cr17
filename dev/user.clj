 (ns user
   (:require [reloaded.repl :refer [set-init! system init start stop go reset reset-all]]
             ...
             [org.arachne-framework.cr17 :as app])
   )
...
(defn init-arachne
  ...
  [runtime]
  (let [cfg (a/config :org.arachne-framework/cr17)
...
(comment
  ...
  (def cfg (a/config :org.arachne-framework/cr17))
  (def rt (a/runtime cfg :org.arachne-framework.cr17/runtime))
